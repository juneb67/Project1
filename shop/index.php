...
?>
    ...
    <div class="primary-content">
    	...
    	<div align="center" class="shopRow">
            <div large-4 hide-for-small column><i class="fi-price-tag" id="title3"></i></div>
       		<div large-4 column><h3>Art Available For Purchase!</h3></div>
           	<div large-4 hide-for-small column><i class="fi-paypal" id="title4"></i></div>
            -->
<div class="row">
    	...
    	<div align="center" class="row topRow"><!-- row div for all pics  -->
        	...
        	<div align="center" class="large-4 column shopRow"><!-- first col row  -->
                ...
                <form action="#" method="post">
					...
					<input type="hidden" name="hosted_button_id" value="YMSFFCGRYELEG">
